...
if __name__ == "__main__":
    ...
    # Alternative Abfragen, die vielleicht bessere Ergebnisse liefern
    # erfolg = run_test_without_filter("Die zwölf Weltanschauungen nach Rudolf Steiner")
    # erfolg = run_test_without_filter("12 Weltanschauungen Materialismus Idealismus Spiritualismus")
